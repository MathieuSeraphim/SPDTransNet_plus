...
class VectorizedSPDFromEEGSuccessiveChannelsTransformerModel(SequenceToClassificationBaseModel):
    ...
    def obtain_example_input_array(self):
        ...
        sequence_of_vectorized_spd_matrices = torch.rand(placeholder_batch_size, self.original_number_of_channels, self.sequences_of_epochs_length, self.number_of_subdivisions_per_epoch, self.original_vector_size, dtype=self.dtype)
