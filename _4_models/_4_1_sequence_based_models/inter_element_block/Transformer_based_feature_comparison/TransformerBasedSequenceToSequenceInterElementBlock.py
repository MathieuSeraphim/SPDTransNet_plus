...
class TransformerBasedSequenceToSequenceInterElementBlock(BaseInterElementBlock):

    def __init__(self):
        super(TransformerBasedSequenceToSequenceInterElementBlock, self).__init__()
