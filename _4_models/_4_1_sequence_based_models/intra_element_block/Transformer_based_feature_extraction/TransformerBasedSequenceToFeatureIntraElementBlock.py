...
from _4_models._4_1_sequence_based_models.intra_element_block.Transformer_based_feature_extraction.layers.AveragePoolingLayer import \
    AveragePoolingLayer
from _4_models._4_1_sequence_based_models.intra_element_block.Transformer_based_feature_extraction.layers.PositionalEncodingLayer import \
    PositionalEncodingLayer
from _4_models._4_1_sequence_based_models.intra_element_block.Transformer_based_feature_extraction.layers.StandardTransformerEncoderLayer import \
    StandardTransformerEncoderLayer


class TransformerBasedSequenceToFeatureIntraElementBlock(BaseIntraElementBlock):

    def __init__(self):
        super(TransformerBasedSequenceToFeatureIntraElementBlock, self).__init__()
    ...
    def setup(self, sequence_length: int, number_of_vectors_per_element: int,
        ...
        assert 0 < number_of_vectors_per_element
        ...
        self.average_pooling.setup(self.number_of_vectors_per_element, 1, self.vector_size, True)

        self.__setup_done_flag = True

    # element_as_sequence_of_vectors of shape (batch_size, sequence_length, number_of_vectors_per_element, vector_size)
    # output of shape (batch_size, sequence_length, vector_size)
    def forward(self, element_as_sequence_of_vectors: torch.Tensor):
        ...
        output_element_feature_vectors = averaged_transformed_vectors.view(batch_size, sequence_length, vector_size)
