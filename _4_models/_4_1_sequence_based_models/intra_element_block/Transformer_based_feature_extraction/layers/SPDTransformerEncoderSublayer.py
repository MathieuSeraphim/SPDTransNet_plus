...
from _4_models._4_1_sequence_based_models.intra_element_block.Transformer_based_feature_extraction.layers.SPDMultiheadAttention import \
    SPDMultiheadAttention
...
class SPDTransformerEncoderSublayer(TransformerEncoderLayer):
    ...
    def __init__(self,  d_model: int, nhead: int, dim_feedforward: int = 2048, dropout: float = 0.1,
        ...
        self.self_attn = SPDMultiheadAttention(d_model, nhead, dropout=dropout, batch_first=batch_first, device=device,
                                               dtype=dtype)
