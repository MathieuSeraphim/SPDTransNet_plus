...
class MultichannelWindowFeatureLearningPretraining(FeatureExtractorPretrainingBaseModel):

    COMPATIBLE_EXTRACTOR_MODELS = (MultichannelWindowFeatureLearningModel,)
    ...
    def __init__(self, loss_function_config_dict: Dict[str, Any], class_labels_list: List[str],
                 ...
                 number_of_output_features: int, output_feature_length: int, learning_rate: float,
                 non_default_inputs_kwargs: Optional[Dict[str, Any]] = None,
                 optimisation_config_dict: Optional[Dict[str, Any]] = None):
        ...
        super(MultichannelWindowFeatureLearningPretraining, self).__init__(loss_function_config_dict,
        ...
        self.extractor_setup_kwargs = {
            ...
            "non_default_inputs_kwargs": non_default_inputs_kwargs
        }
    ...
    def forward(self, input_signal):
        return super(MultichannelWindowFeatureLearningPretraining, self).forward(input_signal=input_signal)
