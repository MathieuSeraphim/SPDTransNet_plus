...
class MultichannelDeepSleepNetFeatureExtractorPretraining(FeatureExtractorPretrainingBaseModel):
    ...
    def __init__(self, loss_function_config_dict: Dict[str, Any], class_labels_list: List[str],
                 ...
                 first_layers_shape_argument: int, number_of_output_features: int, output_feature_length: int,
        ...
        super(MultichannelDeepSleepNetFeatureExtractorPretraining, self).__init__(loss_function_config_dict,
        ...
        self.extractor_setup_kwargs = {
            ...
            "first_layers_shape_argument": first_layers_shape_argument,
    ...
    def forward(self, input_signal):
        return super(MultichannelDeepSleepNetFeatureExtractorPretraining, self).forward(input_signal=input_signal)
