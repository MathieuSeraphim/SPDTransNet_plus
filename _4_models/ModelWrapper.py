...
def get_model_config_dict_from_file(config_file: str, cross_validation_fold_index: Union[int, None] = None,
                                    signals_batch_size: Union[int, None] = None):
    ...
    model_config_dict = modify_model_config_dict(model_config_dict, cross_validation_fold_index, signals_batch_size)
...
def get_model_from_config_file(config_file: str, cross_validation_fold_index: Union[int, None] = None,
                               signals_batch_size: Union[int, None] = None):
    model_config_dict = get_model_config_dict_from_file(config_file, cross_validation_fold_index, signals_batch_size)
...
def modify_model_config_dict(config_dict: Dict[str, Any], cross_validation_fold_index: Union[int, None] = None,
    ...
    if signals_batch_size is not None:
        config_dict["init_args"]["signals_batch_size"] = signals_batch_size
    return config_dict
