...
# Job name
#SBATCH -J "preprocessing_MASS_SS1_for_learned_augmentation"
...
set -x
srun python -u run_preprocessing.py SPD_matrices_and_signals_from_EEG_MASS_SS1_dataset_EUSIPCO_signals_config.yaml
