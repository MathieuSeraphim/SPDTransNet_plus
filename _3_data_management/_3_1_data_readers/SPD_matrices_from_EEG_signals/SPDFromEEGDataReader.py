...
class SPDFromEEGDataReader(BaseDataReader):
    ...
    def parse_preprocessor_attributes(self):
        ...
        self.correct_non_spd_matrices = self.corresponding_preprocessor_object.correct_non_spd_matrices
        self.impose_minimal_eigenvalue = self.corresponding_preprocessor_object.impose_minimal_eigenvalue
        ...
        for recording_id in range(number_of_recordings):
            ...
            for epoch_id_in_recording in range(number_of_epochs_in_recording):
                ...
                epoch_dict = {"epoch id in recording": epoch_id_in_recording}
    ...
    def get_element_data(self, element_id: int):
        ...
        epoch_id_in_recording = epoch_metadata_dict["epoch id in recording"]
        ...
        epoch_data_dict["epoch id in recording"] = epoch_id_in_recording
