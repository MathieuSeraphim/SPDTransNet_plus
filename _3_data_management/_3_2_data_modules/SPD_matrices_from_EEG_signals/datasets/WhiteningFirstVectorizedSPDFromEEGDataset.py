...
class WhiteningFirstVectorizedSPDFromEEGDataset(SPDFromEEGDataset):
    ...
    def __init__(self, eeg_signals: List[str], labels: List[str], data_reader_config_file: str):
        super(WhiteningFirstVectorizedSPDFromEEGDataset, self).__init__(eeg_signals, labels, data_reader_config_file)
    ...
    def setup(self, recording_indices: List[int], extra_epochs_on_each_side: int, signal_preprocessing_strategy: str,
        ...
        super(WhiteningFirstVectorizedSPDFromEEGDataset, self).setup(recording_indices, extra_epochs_on_each_side,
