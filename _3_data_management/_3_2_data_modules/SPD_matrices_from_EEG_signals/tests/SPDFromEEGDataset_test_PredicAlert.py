...
recording_indices_and_rebalance_set_by_oversampling_list = [(list(range(61)), False), (list(range(61)), True), ([39, 23, 55, 11], True)]
...
statistic_vectors_to_return_list = [["psd"], []]
transfer_recording_wise_matrices = True
data_reader_config_file = "SPD_matrices_from_EEG_PredicAlert_config.yaml"
preprocessed_dataset_name = "PredicAlert_dataset_with_PredicAlert_signals_config"
    ...
    for extra_epochs_on_each_side in extra_epochs_on_each_side_list:
        for statistic_vectors_to_return in statistic_vectors_to_return_list:
            for clip_recordings_by_amount in clip_recordings_by_amount_list:
                ...
                classes_in_set = classes_in_set_1
                for index in recording_indices:
                    if index in ids_for_classes_in_set_2:
                        classes_in_set = classes_in_set_2
                ...
                if not rebalance_set_by_oversampling:
                    ...
                    expected_dataset_length = expected_data_distribution_dict["Awake"] * classes_in_set
