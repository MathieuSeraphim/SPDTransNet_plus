...
def get_datamodule_config_dict_from_file(config_file: str, batch_size: Union[int, None] = None,
                                         cross_validation_fold_index: Union[int, None] = None):
    ...
    data_module_config_dict = yaml.safe_load(open(data_module_config_file, "r"))
    data_module_config_dict = modify_datamodule_config_dict(data_module_config_dict, batch_size,
                                                            cross_validation_fold_index)

    return data_module_config_dict


def get_datamodule_from_config_file(config_file: str, batch_size: Union[int, None] = None,
                                    cross_validation_fold_index: Union[int, None] = None):
    data_module_config_dict = get_datamodule_config_dict_from_file(config_file, batch_size, cross_validation_fold_index)
    return get_datamodule_from_config_dict(data_module_config_dict)


def modify_datamodule_config_dict(config_dict: Dict[str, Any], batch_size: Union[int, None] = None,
                                  cross_validation_fold_index: Union[int, None] = None):
